...
function GameItemExtendable() {
    ...
    return (
        <div
            className={"flex flex-row group relative w-1/6 box-border hover:border hover:border-background-pop " + (isHovering ? "aspect-4/3 min-w-[360px] max-w-[720px]" : "aspect-2/3 min-w-[180px] max-w-[360px]")}
            ...
            />
            <div
                className={"bg-background-light/40 backdrop-blur-lg h-full gap-2 p-4 flex flex-col justify-between aspect-2/3 opacity-0 group-hover:opacity-100 transition-opacity duration-500"}>
